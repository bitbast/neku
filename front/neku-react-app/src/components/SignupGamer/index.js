          ...
          <Row form>
            <Col md={4}>
              ...
              <FormGroup>
                ...
                <Input type="text" name="fatherLastName" id="signupLastName" placeholder="> " />
              </FormGroup>
              <FormGroup>
                <Label for="signupMotherLastName">Apellido Materno</Label>
                <Input type="text" name="motherLastName" id="signupMotherLastName" placeholder="> " />
              </FormGroup>
              <FormGroup>
            ...
            <Col md={4}>
              ...
              <FormGroup>
                ...
                <Input type="text" name="tournamentsPlayed" id="signupTournamentsPlayed" placeholder="> " />
              </FormGroup>
              <FormGroup>
                <Label for="signupGamesPlayed">Juegos</Label>
                <Input type="text" name="gamesPlayed" id="signupGamesPlayed" placeholder="> " />
              </FormGroup>
              <FormGroup>
                <Label for="signupGamerProfile">Bio</Label>
                <Input type="textarea" name="gamerProfile" id="signupGamerProfile" placeholder="Cuéntanos algo de ti" />
              </FormGroup>
            </Col>
            <Col md={4} sm={6}>
              <FormGroup>
              ...
              <FormGroup>
                ...
                <Input type="file" name="gamerPicture" id="signupGamerPicture" />
              </FormGroup>
            </Col>
            <Col>
