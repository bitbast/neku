            ...
            <Container fluid className="textContainer">
                <Row className="">
                    ...
                    <Col xs="12" md="4" className="d-flex justify-content-center align-items-center">
                        ...
                        <br />Los datos personales que nos proporciona son utilizados estrictamente en la realización de funciones propias de nuestra empresa y <strong>por ningún motivo serán transferidos a terceros.</strong>
                        <br />A nuestros clientes les solicitamos los siguientes datos personales:
                          <ul>
                            <li>
